...
const NAV = [
  ...
  { to: "/admin/portals", label: "Portals", icon: Boxes },
    ...
    <div className="min-h-screen flex">
      ...
      <aside className="w-[220px] shrink-0 bg-[color:var(--surface)] border-r border-[color:var(--border)] flex flex-col">
        <div className="px-5 py-5 border-b border-[color:var(--border)]">
          ...
          <div className="ma-label mt-1">Internal CRM</div>
        </div>
        ...
        <div className="px-5 py-4 border-t border-[color:var(--border)]">
          ...
          <div className="ma-status-pill mt-2">
            <span className="ma-status-dot" /> {roleLabel}
          </div>
          <button
            onClick={signOut}
      ...
      <main className="flex-1 min-w-0">
        <header className="h-12 border-b border-[color:var(--border)] flex items-center px-6 bg-[color:var(--background)]/60 backdrop-blur">
